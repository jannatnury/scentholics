    ...
    return (
        <div className='banner-container row container m-auto'>
            ...
            <div className='banner-text col-lg-6 col-sm-12 '>
                ...
                <p className='font-monospace text-secondary'>Perfume is the key to our memories.Perfume is the art that makes memory speek.You are never fully dressed without perfume.</p>
                <Link to="/gallery">
